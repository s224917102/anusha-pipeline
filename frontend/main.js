// week09/example-2/frontend/main.js
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const PRODUCT_API_BASE_URL = window.PRODUCT_API_BASE_URL || "http://localhost:8000";
    const ORDER_API_BASE_URL   = window.ORDER_API_BASE_URL   || "http://localhost:8001";
